...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './price.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PRICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PRICE actions', async () => {
      const expectedActions = [
        {
