...
import static com.neoris.inditex.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.neoris.inditex.IntegrationTest;
import com.neoris.inditex.config.Constants;
import com.neoris.inditex.domain.User;
import com.neoris.inditex.repository.AuthorityRepository;
import com.neoris.inditex.repository.UserRepository;
import com.neoris.inditex.security.AuthoritiesConstants;
import com.neoris.inditex.service.UserService;
import com.neoris.inditex.service.dto.AdminUserDTO;
import com.neoris.inditex.service.dto.PasswordChangeDTO;
import com.neoris.inditex.service.dto.UserDTO;
import com.neoris.inditex.web.rest.vm.KeyAndPasswordVM;
import com.neoris.inditex.web.rest.vm.ManagedUserVM;
...
class AccountResourceIT {
    ...
    @CsvSource(
        {
            "bob, password, Bob, Green, invalid, false",
            "bob, 123, Bob, Green, bob@example.com, false",
            "bob, , Bob, Green, bob@example.com, false",
        }
    )
    @Transactional
    void testRegisterInvalidInputs(String login, String password, String firstName, String lastName, String email, boolean activated)
        throws Exception {
        ManagedUserVM invalidUser = new ManagedUserVM();
